...
sound_player_shoot  = pygame.mixer.Sound(os.path.join("player_shoot.wav"))
sound_enemie_shoot  = pygame.mixer.Sound(os.path.join("enemie_shoot.wav"))
sound_enemie_beaten = pygame.mixer.Sound(os.path.join("enemie_beaten.wav"))
sound_player_beaten = pygame.mixer.Sound(os.path.join("player_beaten.wav"))
...
sprites = pygame.image.load(os.path.join("space-invaders.png")).convert()
live_sheet = pygame.image.load(os.path.join("life.png")).convert()
...
class Player(pygame.sprite.Sprite):
    ...
    def move(self):
        if self.rect.left > 0 and self.rect.right < 800:
